		...
		<div class="guide-outer">
            <div class="guidelines">
				...
				<div class="tab_prdct_sect">
					<ul>
                        <li>
							<span id="gl_tb" class="toggle-btn"><?php esc_html_e( 'Guidelines', 'myworks-sync-for-xero' );?> <i class="fa fa-angle-down"></i></span>
						</li>
					</ul>
					...
					<div id="guide-target">						
						...
						<div class="guide">
							<?php echo esc_html($glc);?>
						</div>
						<?php endforeach;?>
						<?php endif;?>
						<?php else:?>
						<div class="guide">
							<?php echo esc_html($guidelines_content);?>
						</div>
						<?php endif;?>
					</div>
				</div>
				...
				<div class="col col-m auto-map-btn">
					...
					<div class="dropdown-content wqam_ndc">
						<table class="wqam_tbl">
							<tr>
								<td width="50%"><?php esc_html_e( 'WooCommerce Field', 'myworks-sync-for-xero' );?> :</td>
								<td>
